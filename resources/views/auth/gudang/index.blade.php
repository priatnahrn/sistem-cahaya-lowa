...
@section('content')
    ...
    <div x-data="gudangPage()" x-init="init()" class="space-y-6">
        ...
        <div x-show="showFilter" x-collapse x-transition
            class="bg-white border border-slate-200 rounded-xl px-6 py-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div x-transition class="bg-white rounded-xl shadow-lg w-11/12 md:w-1/3 z-10 overflow-hidden">
                ...
                <div class="px-6 py-4">
                    <p class="text-slate-600">
                        ...
                        <span class="font-semibold" x-text="deleteItem.nama"></span> (kode: <span
