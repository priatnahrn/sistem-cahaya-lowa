            ...
            <div class="w-full gap-4">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <input type="text" placeholder="Cari nama kategori..." x-model="filters.nama" @focus="open=true"
                        ...
                        <div x-show="open && filters.nama" x-cloak x-transition
                            ...
                            <div class="p-2">
                                <template
                                    x-for="nama in getUniqueCategories().filter(n => n.toLowerCase().includes(filters.nama.toLowerCase()))"
                                    :key="nama">
                                    <div @click="filters.nama = nama; open = false"
                                        class="px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 cursor-pointer rounded"
                                        x-text="nama"></div>
                                </template>
                                <div x-show="getUniqueCategories().filter(n => n.toLowerCase().includes(filters.nama.toLowerCase())).length === 0"
    ...
    <script>
        ...
        function kategoriPage() {
            return {
                ...
                getUniqueCategories() {
                    return [...new Set(this.data.map(c => c.nama).filter(Boolean))].sort();
                },
                hasActiveFilters() {
