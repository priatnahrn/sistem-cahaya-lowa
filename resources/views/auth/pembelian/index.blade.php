...
@section('content')
    ...
    {{-- CSRF meta (jika layout belum include) --}}
    ...
    <div x-data="pembelianPage()" x-init="init()" class="space-y-6">
        ...
        <div
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('pembelian.index', array_merge(request()->all(), ['export' => 1])) }}"
                    ...
                    <tbody>
                        <template x-for="(r, idx) in pagedData()" :key="r.id">
                            <tr class="hover:bg-slate-50 text-slate-700 border-b border-slate-200">
                                ...
                                <td class="px-4 py-3 text-green-600" x-text="r.supplier"></td>
                        ...
                        <tr x-show="filteredTotal()===0" class="text-center text-slate-500">
                            <td colspan="7" class="px-4 py-6">Tidak ada data pembelian.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
