    ...
    <div class="flex-1 overflow-y-auto px-4 pb-4 mt-4 space-y-7 scrollbar-hide" 
        ...
        <div>
            ...
            @if ($showPembelianSection)
                @php
                    $openPembelian = $open(['pembelian.*', 'retur-pembelian.*', 'tagihan-pembelian.*']);
                @endphp
        ...
        @php
            ...
            $canViewMutasi = auth()->user()->can('mutasi-stok.view');
        ...
        {{-- ==================== --}}
        @php
            $canViewKas = auth()->user()->can('laporan.view');
            $canViewGaji = auth()->user()->can('laporan.view');
